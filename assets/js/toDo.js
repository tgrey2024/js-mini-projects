...
function addToDo(e) {
    if (listTextInput.value) {
        ...
        newToDoElement.innerHTML = `${toDoText} <button class="deleteBtn btn btn-bd-primary mx-1" data-bs-toggle="popover">X</button><button class="doneBtn btn btn-bd-primary mx-1" data-bs-toggle="popover">Done</button>`;
